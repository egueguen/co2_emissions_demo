...
emissions_long_subset = emissions_long_1990_2022.query(
    "country.isin(@five_country_choose)"
)
...
fig_chart = px.line(
    ...
    y="emissions",
    color="country",
    title="CO2 Emissions Evolution (1990-2022)",
    labels={"year": "Time (Year)", "emissions": "CO2 Emissions", "country": "Country"},
)

fig_chart.update_layout(
    xaxis_title="Year",
    yaxis_title="Emissions (in metric tons)",  # Adjust unit if necessary
    legend_title="Country",
    template="plotly_white",  # Use a clean background style
    hovermode="x unified",  # Show all values when hovering over a year
)
```
...
import random
five_country = emissions_long_1990_2022["country"].unique()
choice_country = random.sample(list(five_country), 5)  
